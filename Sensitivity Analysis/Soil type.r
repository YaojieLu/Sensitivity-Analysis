...
windows(8, 6)
par(mgp=c(2.2, 1, 0), xaxs="i", yaxs="i", lwd=2, mar=c(3.5, 3.5, 1, 4), mfrow=c(1, 1))
...
legend("topleft", legend=c("Sand", "Sandy Loam", "Light Clay"), col=Cols, pch=19, title=expression(italic(h[3])))
