...
windows(8, 6)
par(mgp=c(2.2, 1, 0), yaxs="i", lwd=2, mar=c(4, 4, 0.5, 0.5), mfrow=c(2, 2))
# average A
...
axis(2, xlim=c(0, 15), pos=-100*0.04, lwd=2, at=seq(0, 15, by=5))
...
text(-100*0.04+100*1.08*0.05/8*6, 15*0.95, "a", cex=1.5)
#
#par(new=TRUE)
...
legend("bottomright", expression(italic(bar(A)), italic(bar(B))), col=Cols, lty=c(1, 1), lwd=c(2, 2))
box()
