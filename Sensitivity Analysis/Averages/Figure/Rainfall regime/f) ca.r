...
colnames(data) <- c("Var", "k", "MAP", "wL", "fwL", "averA", "EMAP", "averm", "averB", "avrw", "averci/ca")
...
# average A
plotBy(data$averA ~ data$MAP | Var, data=subset(data, k=="0.025"),
...
plotBy(data$averA ~ data$MAP | Var, data=subset(data, k=="0.1"),
       type='l', legend=FALSE, legendwhere="topleft",
       xlim=c(0, 4000), ylim=c(0, 25),
       xlab=NA, ylab=NA,
       xaxt="n", yaxt="n",
...
text(4000-4000*0.05/8*6, 25*0.95, "f", cex=1.5)
